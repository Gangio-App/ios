...
//            if navigationAction.navigationType == .linkActivated, let url = navigationAction.request.url, url.host() == "app.gangio.chat" {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        let js = """
            ...
            document.addEventListener("click", (evt) => {
                ...
                if (el && el.href.startsWith("https://app.gangio.chat/server")) {
