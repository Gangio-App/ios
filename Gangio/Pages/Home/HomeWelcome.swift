    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .center, spacing: 24) {
                ...
                VStack {
                    HomeButton(title: "Discover Gangio", description: "Find a community based on your hobbies or interests.") {
                    ...
                    HomeButton(title: "Donate to Gangio", description: "Support the project by donating - thank you") {
